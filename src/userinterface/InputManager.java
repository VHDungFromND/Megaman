        ...
        switch(code) {
            case KeyEvent.VK_T:
                if(gameWorld.state==GameWorld.GAMEPLAY) {
                    if(GameWorld.Level==1) GameWorld.Level=2;
                    else {
                        GameWorld.Level=1;
                ...
                break;
            case KeyEvent.VK_3:
                if(gameWorld.naruto.permitToRun && !gameWorld.naruto.isSuperAttack) gameWorld.naruto.run();
                break;
            case KeyEvent.VK_J:
                if(gameWorld.gaara.permitToRun && !gameWorld.gaara.isSuperAttack) gameWorld.gaara.run();
                break;
            case KeyEvent.VK_S:
            ...
            case KeyEvent.VK_ENTER:
                ...
                if(gameWorld.state==GameWorld.TUTORIAL && gameWorld.storyTutorial>=1) {
                    if(gameWorld.storyTutorial<=3) {
                        if(gameWorld.storyTutorial!=3) gameWorld.storyTutorial++;
                        else if(GameWorld.Level!=0) gameWorld.storyTutorial++;
                ...
                break;
            case KeyEvent.VK_W:
                if(!gameWorld.naruto.isSuperAttack)
            ...
            case KeyEvent.VK_K:
                ...
                break;
            case KeyEvent.VK_5:
                if(!gameWorld.naruto.isRunning && !gameWorld.naruto.getIsTimeLimit() && !gameWorld.naruto.getIsJumping())
